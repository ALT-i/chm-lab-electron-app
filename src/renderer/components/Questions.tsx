...
const Questions = () => {
  ...
  const setActivity = (id: string) => {
    const arrhead = document.getElementById(`arrhead-${id}`)
    const compartment = document.getElementById(`compartment-${id}`)

    arrhead?.classList.toggle('active')
    compartment?.classList.toggle('active')
  }
